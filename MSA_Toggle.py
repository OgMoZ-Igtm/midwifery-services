...
# CORRECTION: Changement de la clé de 'audio_toggle' à 'main_sidebar_audio_toggle' pour éviter le conflit
# avec l'élément de même clé qui se trouve dans un module de dashboard, résolvant ainsi l'erreur de duplication.
st.session_state["audio_running"] = st.sidebar.toggle(
    "Activer le son",
    value=st.session_state["audio_running"],
    key="main_sidebar_audio_toggle",
)
...
def render_sidebar_auth(role: str):
    ...
    st.sidebar.info("🔇 Le son est en pause.")
