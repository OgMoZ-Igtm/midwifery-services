...
# ============================================================================
# 📋 Détection automatique des modules de formulaires NURSE
# ============================================================================
def discover_nurse_modules(base_path="modules"):
    modules = []
    base = pathlib.Path(base_path)
    role_dir = base / "forms_nurse"
    if role_dir.exists():
...
NURSE_MODULES = discover_nurse_modules()
...
# 🚀 Interface Streamlit
# ============================================================================
st.title("🔎 Diagnostic et test automatique des formulaires NURSE")

results_all = []

for module_name in NURSE_MODULES:
...
st.download_button(
    "📥 Exporter diagnostic en CSV", csv, file_name="diagnostic_forms_nurse.csv"
)
