...
# =========================================================
st.set_page_config(page_title="🌾 Accueil DOCTOR", page_icon="🌾", layout="wide")
...
if "user_name" not in st.session_state:
    st.session_state.user_name = "Doctor"
...
if __name__ == "__main__":
    st.title("L'application n'est pas censée être exécutée directement.")